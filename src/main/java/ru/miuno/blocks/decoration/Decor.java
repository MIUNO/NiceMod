...
public class Decor extends Horizontal{
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext ctx) {
		...
		return switch (dir) {
			case NORTH -> Block.createCuboidShape(2, 0, 2, 14, 16, 14);
			case SOUTH -> Block.createCuboidShape(2, 0, 2, 14, 16, 14);
			case EAST -> Block.createCuboidShape(2, 0, 2, 14, 16, 14);
			case WEST -> Block.createCuboidShape(2, 0, 2, 14, 16, 14);
